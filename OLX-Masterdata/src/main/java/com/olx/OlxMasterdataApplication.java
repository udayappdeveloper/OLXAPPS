...
public class OlxMasterdataApplication {
	...
	private ApiInfo getApiInfo() {
		...
		return new ApiInfo("Olx-Master Data API Documentation", "Olx Data API Released By Zensar Ltd", "2.5",
				"https:zensar.com/termsofservice",
				new Contact("Udaykumar", "http://uday.comcom", "uday@zensar@zensar.com"), "GPL", "http://gpl.com",
